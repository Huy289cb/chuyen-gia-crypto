...
const (
	...
	PendingOrdersTable = "pending_orders"
	// PendingOrdersInverseTable is the table name for the PendingOrder entity.
	// It exists in this package in order to avoid circular dependency with the "pendingorder" package.
	PendingOrdersInverseTable = "pending_orders"
...
var (
	...
	// DefaultStartingBalance holds the default value on creation for the "starting_balance" field.
	DefaultStartingBalance float64
	// DefaultCurrentBalance holds the default value on creation for the "current_balance" field.
	DefaultCurrentBalance float64
	// DefaultEquity holds the default value on creation for the "equity" field.
