...
const (
	// Label holds the string label denoting the ohlcvcandle type in the database.
	Label = "ohlcv_candle"
	...
	// Table holds the table name of the ohlcvcandle in the database.
	Table = "ohlcv_candles"
)

// Columns holds all SQL columns for ohlcvcandle fields.
var Columns = []string{
	FieldID,
	FieldCoin,
	FieldTimestamp,
...
// OrderOption defines the ordering options for the OHLCVCandle queries.
