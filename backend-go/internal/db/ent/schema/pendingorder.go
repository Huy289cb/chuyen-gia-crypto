...
// PendingOrder holds the schema definition for the PendingOrder entity.
type PendingOrder struct {
	ent.Schema
}

// Fields of the PendingOrder.
func (PendingOrder) Fields() []ent.Field {
	return []ent.Field{
...
// Edges of the PendingOrder.
func (PendingOrder) Edges() []ent.Edge {
	return []ent.Edge{
...
// Indexes of the PendingOrder.
func (PendingOrder) Indexes() []ent.Index {
	return []ent.Index{
