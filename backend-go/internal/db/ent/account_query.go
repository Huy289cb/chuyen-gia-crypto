...
type AccountQuery struct {
	...
	withPendingOrders *PendingOrderQuery
...
func (_q *AccountQuery) QueryPositions() *PositionQuery {
...
func (_q *AccountQuery) QueryPendingOrders() *PendingOrderQuery {
	query := (&PendingOrderClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *AccountQuery) QuerySnapshots() *AccountSnapshotQuery {
	query := (&AccountSnapshotClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *AccountQuery) WithPositions(opts ...func(*PositionQuery)) *AccountQuery {
	query := (&PositionClient{config: _q.config}).Query()
...
func (_q *AccountQuery) WithPendingOrders(opts ...func(*PendingOrderQuery)) *AccountQuery {
	query := (&PendingOrderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AccountQuery) WithSnapshots(opts ...func(*AccountSnapshotQuery)) *AccountQuery {
	query := (&AccountSnapshotClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := _q.withPositions; query != nil {
		if err := _q.loadPositions(ctx, query, nodes,
			func(n *Account) { n.Edges.Positions = []*Position{} },
			func(n *Account, e *Position) { n.Edges.Positions = append(n.Edges.Positions, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPendingOrders; query != nil {
		if err := _q.loadPendingOrders(ctx, query, nodes,
			func(n *Account) { n.Edges.PendingOrders = []*PendingOrder{} },
			func(n *Account, e *PendingOrder) { n.Edges.PendingOrders = append(n.Edges.PendingOrders, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *AccountQuery) loadPositions(ctx context.Context, query *PositionQuery, nodes []*Account, init func(*Account), assign func(*Account, *Position)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(position.FieldAccountID)
	}
	query.Where(predicate.Position(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(account.PositionsColumn), fks...))
	}))
...
func (_q *AccountQuery) loadPendingOrders(ctx context.Context, query *PendingOrderQuery, nodes []*Account, init func(*Account), assign func(*Account, *PendingOrder)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Account)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(pendingorder.FieldAccountID)
	}
	query.Where(predicate.PendingOrder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(account.PendingOrdersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AccountQuery) loadSnapshots(ctx context.Context, query *AccountSnapshotQuery, nodes []*Account, init func(*Account), assign func(*Account, *AccountSnapshot)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Account)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
