...
func (_q *PositionQuery) QueryAccount() *AccountQuery {
...
func (_q *PositionQuery) QueryEvents() *TradeEventQuery {
	query := (&TradeEventClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *PositionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PositionQuery) FirstIDX(ctx context.Context) int {
...
func (_q *PositionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PositionQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *PositionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *PositionQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PositionQuery) WithAccount(opts ...func(*AccountQuery)) *PositionQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *PositionQuery) WithEvents(opts ...func(*TradeEventQuery)) *PositionQuery {
	query := (&TradeEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PositionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Position, error) {
	...
	if query := _q.withAccount; query != nil {
		if err := _q.loadAccount(ctx, query, nodes, nil,
			func(n *Position, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withEvents; query != nil {
		if err := _q.loadEvents(ctx, query, nodes,
			func(n *Position) { n.Edges.Events = []*TradeEvent{} },
			func(n *Position, e *TradeEvent) { n.Edges.Events = append(n.Edges.Events, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PositionQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Position, init func(*Position), assign func(*Position, *Account)) error {
...
func (_q *PositionQuery) loadEvents(ctx context.Context, query *TradeEventQuery, nodes []*Position, init func(*Position), assign func(*Position, *TradeEvent)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tradeevent.FieldPositionID)
	}
	query.Where(predicate.TradeEvent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(position.EventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PositionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAccount != nil {
			_spec.Node.AddColumnOnce(position.FieldAccountID)
		}
	}
