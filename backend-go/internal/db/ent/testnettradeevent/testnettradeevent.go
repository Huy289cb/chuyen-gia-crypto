...
const (
	// Label holds the string label denoting the testnettradeevent type in the database.
	Label = "testnet_trade_event"
	...
	// Table holds the table name of the testnettradeevent in the database.
	Table = "testnet_trade_events"
	// PositionTable is the table that holds the position relation/edge.
	PositionTable = "testnet_trade_events"
	// PositionInverseTable is the table name for the TestnetPosition entity.
	// It exists in this package in order to avoid circular dependency with the "testnetposition" package.
	PositionInverseTable = "testnet_positions"
	// PositionColumn is the table column denoting the position relation/edge.
	PositionColumn = "position_id"
)

// Columns holds all SQL columns for testnettradeevent fields.
var Columns = []string{
	FieldID,
	FieldPositionID,
	FieldEventType,
...
// OrderOption defines the ordering options for the TestnetTradeEvent queries.
