 ...
 */
export function toBinanceSide(internalSide: string): string {
 ...
 */
export function fromBinanceSide(binanceSide: string): string {
  if (binanceSide === 'BUY') {
    return 'long';
 ...
 */
export function toBinanceOrderType(internalType: string): string {
 ...
 */
export function isValidBinanceSide(side: string): boolean {
 ...
 * @returns {boolean} True if valid
 */
export function isValidInternalSide(side: string): boolean {
 ...
 * @returns {boolean} True if valid
 */
export function isValidBinanceOrderType(type: string): boolean {
