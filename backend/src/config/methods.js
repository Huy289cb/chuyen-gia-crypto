...
OUTPUT FORMAT (JSON, VIETNAMESE):
{
  "btc": {
    ...
    "suggested_entry": number (REQUIRED for trading),
    "suggested_stop_loss": number (REQUIRED: below entry for long/above entry for short),
    "suggested_take_profit": number (REQUIRED: above entry for long/below entry for short),
